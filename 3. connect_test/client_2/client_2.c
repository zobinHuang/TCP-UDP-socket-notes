//client_2.c: connect to another client, after successfully connected send and receive message.
#include <stdio.h>
#include <string.h>
#include <errno.h>
...
int main()
{
    ...
    client_addr.sin_family = AF_INET;
        ...
        client_addr.sin_addr.S_un.S_addr = inet_addr(CLIENT_2_IP);
    #elif __linux__
        //client_addr.sin_addr.s_addr = htonl(INADDR_ANY);
        client_addr.sin_addr.s_addr = inet_addr(CLIENT_2_IP);
    #endif
    client_addr.sin_port = htons(CLIENT_2_TCP_PORT);
    ...
    remote_addr.sin_family = AF_INET;
        ...
        remote_addr.sin_addr.S_un.S_addr = inet_addr(CLIENT_1_IP);
    #elif __linux__
        //remote_addr.sin_addr.s_addr = htonl(INADDR_LOOPBACK);
        remote_addr.sin_addr.s_addr = inet_addr(CLIENT_1_IP);
    #endif
    remote_addr.sin_port = htons(CLIENT_1_TCP_PORT);
    ...
    strcpy(sendbuf, "Hi! I'm client 2");
