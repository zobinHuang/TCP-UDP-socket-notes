//example2.c: create a socket, observe the allocated id of socket (try five times, and run socket() alternately with example1), and send message to server2 then recv answer.
#include <stdio.h>
#include <string.h>
#include <errno.h>
...
int main()
{
    ...
    */
    ...
    strcpy(sendbuf, "Hi! I'm example 2");
